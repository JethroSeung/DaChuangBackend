...
class GeofenceTest {
    ...
    void testFenceTypeEnum() {
        assertEquals(3, Geofence.FenceType.values().length);

        assertNotNull(Geofence.FenceType.CIRCULAR);
        assertNotNull(Geofence.FenceType.POLYGONAL);
        assertNotNull(Geofence.FenceType.RECTANGULAR);
        ...
        geofence.setFenceType(Geofence.FenceType.RECTANGULAR);
        assertEquals(Geofence.FenceType.RECTANGULAR, geofence.getFenceType());
    }
