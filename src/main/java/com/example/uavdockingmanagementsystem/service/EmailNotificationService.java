...
import com.example.uavdockingmanagementsystem.model.Notification;
...
public class EmailNotificationService {
    ...
    public boolean sendNotificationEmail(Notification notification) {
        ...
        try {
            Map<String, Object> variables = Map.of(
                ...
                "recipientUsername", notification.getRecipientUsername() != null ? notification.getRecipientUsername() : "User",
            ...
            logger.error("Failed to send notification email for notification {}: {}", notification.getId(), e.getMessage());
            return false;
        }
    }
     ...
     */
    public boolean sendMaintenanceReminderEmail(String to, String uavRfid, String maintenanceType, LocalDateTime scheduledDate) {
        try {
            Map<String, Object> variables = Map.of(
                "uavRfid", uavRfid,
     ...
     */
    public void sendBulkNotification(String[] recipients, String subject, String templateName, Map<String, Object> variables) {
